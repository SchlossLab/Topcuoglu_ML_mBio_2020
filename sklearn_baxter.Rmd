---
title: "Logistic Regression, MLP and Random Forest on Baxter Dataset"
...
```{python, echo=T, results='hide', cache=FALSE, message=FALSE, warning=FALSE, engine.path = '/Library/Frameworks/Python.framework/Versions/3.6/bin/python3'}
###### IMPORT MODULES #######
