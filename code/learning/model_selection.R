...
#       Return 2class summary and save predictions to calculate cvROC
  ...
  if(model=="L2_Logistic_Regression") {
    ...
    grid <-  expand.grid(sigma = c(0.000000000001, 0.00000000001, 0.0000000001, 0.000000001, 0.000000005, 0.0000005, 0.000001, 0.000005, 0.00001, 0.00005),
                         C = c(0.00001, 0.0001, 0.001, 0.01, 0.1, 1))
    method <-"svmRadial"
  }
