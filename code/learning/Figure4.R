...
perm <- plot_grid(logit_plot, l1_plot, l2_plot, rbf_plot, dt_plot, rf_plot, xgboost_plot, labels = c("A", "B", "C", "D", "E", "F", "G"))
ggdraw(add_sub(perm, "AUROC with the OTU permuted randomly", vpadding=grid::unit(0,"lines"), y=5, x=0.5, vjust=4.5))
