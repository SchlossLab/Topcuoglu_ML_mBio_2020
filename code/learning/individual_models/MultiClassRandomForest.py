...
n_estimators = [1000]
max_features= [1000]
param_grid = dict(estimator__n_estimators=n_estimators, estimator__max_features=max_features)
cv = RepeatedKFold(n_splits=5, n_repeats=5, random_state=200889)
model = OneVsRestClassifier(RandomForestClassifier(bootstrap= True, criterion='entropy'))
