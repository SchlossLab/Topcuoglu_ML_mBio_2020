...
cp $SEARCH_DIR/"$MODEL"_"$DATA"_1.tsv $FINAL_DIR/combined_"$MODEL"_"$DATA".tsv
...
tail -n +2 -q $SEARCH_DIR/"$MODEL"_"$DATA"_{1..300}.tsv >> $FINAL_DIR/combined_"$MODEL"_"$DATA".tsv