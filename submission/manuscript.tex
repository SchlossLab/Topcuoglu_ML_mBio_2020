...
evaluating the rigor of ML practices applied to microbiome data
{[}Figure S1{]} to urge the audience to be diligent with with their
study design, model selection, development, evaluation and
interpretation.
...
permutation importance {[}Figure S6{]}, 17 of the 20 top OTUs (e.g., OTU
...
\textbf{Figure S5. NMDS ordination of Bray-Curtis distances.} NMDS
...
\includegraphics[height=20cm, width=13cm]{Figure_S8.pdf}
