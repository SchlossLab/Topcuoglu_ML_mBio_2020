...
ML model interpretation methods in the previous studies microbiome studies lacked clarity and transparency. The studies that made the model interpreatation code publicly available, used default functions in previously built packages in R, python and matlab. In this study we used two methods to interpret our models. Feature weights of trained models ad permutation importance. the differences between the two interpretation methods
