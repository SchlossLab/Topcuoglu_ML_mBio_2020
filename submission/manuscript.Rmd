...
We use FIT results and OTU abundances as features. However these are in different scales. We use MinMaxScaler to transforms features by scaling each feature to a [0-1] range.
