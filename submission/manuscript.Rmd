...
**Figure S5. NMDS ordination with Bray-Curtis distances.** 

\newpage
\includegraphics[height=17.5cm, width=13cm]{Figure_S6.png}

**Figure S6. Interpretation of the linear ML models with permutation importance.** (A) L1-regularized SVM with linear kernel, (B) L2-regularized SVM with linear kernel, and (C) L2-regularized logistic regression were interpreted using permutation importance using held-out test set. 
