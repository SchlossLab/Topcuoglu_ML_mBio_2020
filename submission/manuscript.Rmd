...
We use FIT results and OTU abundances as features. However these are in different scales. We use python v`r paste(py$python_version)`, module scikit-learn v`r paste(py$sklearn_module)` function MinMaxScaler() to transform features by scaling each feature to a [0-1] range.
